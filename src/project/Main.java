...
public class Main {
    ...
    private static void testDigitalRootPersistenceAPI() {
        ...
        for (int i = 0; i < testNumbers.length; i++) {
            ...
            System.out.println("Input: " + testNumbers[i] + ", Expected: " + expectedResults[i] + ", Actual: " + result + (correct ? " ✓" : " ✗"));
        }
        ...
        System.out.println("Original implementation: " + originalTime + " ms for " + iterations + " iterations of " + largeNumbers.length + " large numbers.");
        start = System.currentTimeMillis();
        for (int j = 0; j < iterations; j++) {
            for (int num : largeNumbers) {
        ...
        System.out.println("Optimized implementation: " + fastTime + " ms for " + iterations + " iterations of " + largeNumbers.length + " large numbers.");
