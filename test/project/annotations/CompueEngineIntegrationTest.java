...
public class ComputeEngineIntegrationTest {
    ...
    public void integrationTest() {
        ...
        // Alternatively, if the InMemoryDataStore were responsible for the processing,
        // you could call: dataStore.processData();
        // But note: InMemoryDataStore's processData() in this example writes "Processed: <num>"
